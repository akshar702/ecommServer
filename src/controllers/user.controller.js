...
const client = new OAuth2Client(process.env.GOOGLE_CLIENT_ID);  // Your Google client ID here
...
// Function to generate a JWT token (Example)
...
const loginUserWithGoogle = asyncHandler(async (req, res) =>{
      ...
      try {
        ...
        const ticket = await client.verifyIdToken({
          idToken: token,
          audience: process.env.GOOGLE_CLIENT_ID  // Ensure this is your Google client ID
        });
        ...
        // Respond with the JWT or session info
        return res
            .status(200)
            .json(
                new ApiResponse(
